...
Because the characteristics of the property sold isn't open source, the data you'll be working with are **synthetic data**.
It has been generated to mirror the original data.   

If you want to have a closer look at the data, CEREMA publishes on [its website](](https://doc-datafoncier.cerema.fr/doc/ff/pb0010_local)) an extensive documentation of the different datasets, the variables, their modalities and the overall quality of variable. 
...
Note that the variable year of the building has been harmonized to correct for typing mistakes. 
Here are the transformation made from the original data : 
...
More information about this transformation is available [online](https://doc-datafoncier.cerema.fr/doc/ff/pb40_pevprincipale/jannath) (in French). 