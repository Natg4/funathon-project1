...
preprocessor = ColumnTransformer([
    ...
    ("cat", OneHotEncoder(), ["region", "job_type", "prop_year_harm_10"]) #Onehtencoder sert à créer des binaires pour chaque modalité
    ],
...
pipeline = Pipeline([
    ("preprocessor", preprocessor), #Ce qui est entre guillemets sert de nom d'étape
